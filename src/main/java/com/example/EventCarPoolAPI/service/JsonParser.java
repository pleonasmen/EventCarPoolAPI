package com.example.EventCarPoolAPI.service;
import com.example.EventCarPoolAPI.journeyhandling.Journey;
import com.example.EventCarPoolAPI.journeyhandling.JourneyRepository;
import com.example.EventCarPoolAPI.journeyhandling.UserJourneyRequest;
import com.example.EventCarPoolAPI.journeyhandling.UserJourneyRequestRepository;
import com.example.EventCarPoolAPI.posthandling.*;
import com.example.EventCarPoolAPI.userhandling.*;
...
public class JsonParser {
    ...
    public User parseJsonUser(String user)throws JSONException {
        ...
        String password = elementValues.get(3);
