...
import com.example.EventCarPoolAPI.posthandling.Comment;
import com.example.EventCarPoolAPI.posthandling.Like;
...
//    private List<Journey> requestedJourneys;
    ...
    public User(String firstName, String lastName, String userName, String password, String gender, String emailAddress, String phoneNumber, Long favouriteTeamId, String role) {
    ...
    public User(String firstName, String lastName, String userName, String gender, String email, LocalDate registrationDate, String phoneNumber, String imageURL, Long favouriteTeamId, String role) {
